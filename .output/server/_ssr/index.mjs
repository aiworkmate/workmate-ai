...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-cmx3-byA.mjs");
...
const manifest = {
  "484df29116dc20bfb2829d09f3c853c30f9c109bd163bb61b18efd719ce1a718": {
    functionName: "submitMemoryFeedback_createServerFn_handler",
    importer: () => import("./feedback.functions-Usdc7Qx1.mjs")
  },
  "6cb2bc8359f73e0a2b8fd5f502234a377b2a1550b70ae905649e080231304fcc": {
    functionName: "saveAdminAiControl_createServerFn_handler",
    importer: () => import("./ai-control.server-Bq-WP5Gv.mjs")
  },
  "9933d78bfa6cb9e1110787738c0567db8a38613a65fb146b1299f27474eb7b27": {
    functionName: "getAdminControlPanel_createServerFn_handler",
    importer: () => import("./ai-control.server-Bq-WP5Gv.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-klMIKaP_.mjs").then((n) => n.r),
    import("./start-a99RPf-J.mjs"),
...
const server = createServerEntry({
  async fetch(request) {
    try {
      const response = await server_default.fetch(request);
